...
common_flags = f"--num_workers=8 --entropy_weight=0.006 --max_blame=50000 --lr=1e-3 --n_layers=2 --n_units=100 --epochs=1 --batch_size=5 --ppo_batch_size=64 --LAMBDA=0.987 --discount_factor=0.998 --state_dim={state_dim}"
