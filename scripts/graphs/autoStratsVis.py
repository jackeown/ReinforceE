...
if __name__ == "__main__":
    ...
    if args.dry_run:
        ...
        hists = Parallel(n_jobs=25,verbose=13)(delayed(ECallerHistory.load)(name(x), keysToDeleteFromInfos={"stdout", "stderr", "states", "actions", "rewards"}) for x in histFiles[120])
